...
#ifndef __CXX20_LOG_SYSTEM_HPP
#define __CXX20_LOG_SYSTEM_HPP  
...
private:
	...
	inline const static auto MS_LOGGER_NAME = self::global::config_yaml["log"]["logger-name"].as<std::string>();
	inline const static auto MS_FILENAME = self::global::config_yaml["log"]["filename"].as<std::string>();
	inline const static auto MS_HOUR = self::global::config_yaml["log"]["hour"].as<int>();
	inline const static auto MS_MINUTE = self::global::config_yaml["log"]["minute"].as<int>();
};

#endif // !__CXX20_LOG_SYSTEM_HPP